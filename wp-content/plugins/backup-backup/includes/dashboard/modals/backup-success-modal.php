    ...
    <div class="modal-content">
      ...
      <div id="accessible-at-section" class="mm60">
        ...
        <div class="mms f18 mtl lh30">
          <?php _e('To migrate your site, just copy above link, install our plugin on the target site, go to the', 'backup-backup') ?>
      ...
      <div class="mms mtl flex-here lh50 mm60">
        ...
        <div class="f18 inline align-right">
          <a href="#" class="nlink hoverable" id="download-backup-log-url" download="<?php _e('backup-logs', 'backup-backup') ?>">
