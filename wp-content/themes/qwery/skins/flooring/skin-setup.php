		...
		qwery_storage_set(
			'load_fonts', array(
				...
				array(
					...
					'family' => 'sans-serif',
					'link'   => '',
					'styles' => 'wght@300;400;700',     // Parameter 'style' used only for the Google fonts
				),
			)
		);
		...
		$schemes = array(
			...
			'default' => array(
				...
				'colors'   => array(
					...
					'alter_dark'       => '#232020', // ok
					'alter_link'       => '#FA7D09', // ok
					'alter_hover'      => '#E66C01', // ok
					'alter_link2'      => '#3A3535', // ?
					'alter_hover2'     => '#4D4747', // ?
					'alter_link3'      => '#70798C', // ?
					'alter_hover3'     => '#626B7D', // ?
					...
					'input_bd_hover'   => '#232020', // ok
					'input_text'       => '#797C7F', // ok
					'input_light'      => '#797C7F', // ok
					'input_dark'       => '#232020', // ok
			...
			'dark'    => array(
				...
				'colors'   => array(
					...
					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#232020', // ok
					'alter_bg_hover'   => '#343030', // ok
